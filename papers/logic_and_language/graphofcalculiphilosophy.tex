...
\section{Structural Monotone Calculus}
	\subsection{Structural Rules}
			...
			\UnaryInfC[wL]{$\Gamma , A \vdash \Delta$}
			\end{prooftree}
			\qquad
			\begin{prooftree}
			\AxiomC{$\Gamma \vdash \Delta$}
			\UnaryInfC[Rw]{$\Gamma \vdash A, \Delta$}
			\end{prooftree}

			\begin{prooftree}
			\AxiomC{$\Gamma , A, A \vdash \Delta$}
			\UnaryInfC[cL]{$\Gamma , A \vdash \Delta$}
			\end{prooftree}
			\qquad
			\begin{prooftree}
			\AxiomC{$\Gamma \vdash A, A \Delta$}
			\UnaryInfC[Rc]{$\Gamma \vdash A, \Delta$}
			\end{prooftree}

			\begin{prooftree}
			\AxiomC{$\Gamma_0, A, B, \Gamma_1 \vdash \Delta$}
			\UnaryInfC[pL]{$\Gamma_0, B, A, \Gamma_1 \vdash \Delta$}
			\end{prooftree}
			\qquad
			\begin{prooftree}
			\AxiomC{$\Gamma \vdash \Delta_1, A, B, \Delta_0$}
			\UnaryInfC[Rp]{$\Gamma \vdash \Delta_1, B, A, \Delta_0$}
			\end{prooftree}
		...
		\subsection{Operational Rules}
			...
			\subsubsection{Multiplicatives}
				...
				\BinaryInfC{$\Gamma \vdash A \otimes B, \Delta$}
				\end{prooftree}
				
				\begin{prooftree}
				\AxiomC{$\Gamma , A \vdash \Delta$}
				\AxiomC{$\Gamma , B \vdash \Delta$}
				\BinaryInfC{$\Gamma , A \parr B \vdash \Delta$}
				\end{prooftree}
				\quad
				\begin{prooftree}
	...
	\section{Structural Truth-Preserving Calculus}
		...
		\subsection{Operational Rules}
			...
			\subsubsection{Multiplicatives}
				...
				\AxiomC{$\Gamma , A \vdash \Delta$}
				\AxiomC{$\Gamma \vdash B, \Delta$}
				\BinaryInfC{$\Gamma , A \leftarrow B \vdash \Delta$}
				\end{prooftree}
				\quad
				\begin{prooftree}
				\AxiomC{$\Gamma , B \vdash A, \Delta$}
				\UnaryInfC{$\Gamma \vdash A \leftarrow B, \Delta$}
				\end{prooftree}
				
				\begin{prooftree}
				\AxiomC{$\Gamma \vdash A, B, \Delta$}
				\AxiomC{$\Gamma , A \vdash A, \Delta$}
				\AxiomC{$\Gamma , B \vdash B, \Delta$}
				\AxiomC{$\Gamma , A, B \vdash \Delta$}
				\QuaternaryInfC{$\Gamma , A \leftrightarrow B \vdash \Delta$}
				\end{prooftree}
				\quad
				\begin{prooftree}
				\AxiomC{$\Gamma , A \vdash B, \Delta$}
				\AxiomC{$\Gamma , B \vdash A, \Delta$}
				\BinaryInfC{$\Gamma \vdash A \leftrightarrow B, \Delta$}
				\end{prooftree}
