...
\hypersetup{
	...
	filecolor=magenta,
	urlcolor=cyan,
	pdftitle={Theory of Measurement based on State Reversibility and Information Accessibility},
	pdfpagemode=FullScreen,
}
\usepackage{mathtools}        % For mathematical tools like \coloneqq
\usepackage{physics}          % For physics notations like \ket{}, \expval{}

% === THEOREM STYLES ===
\theoremstyle{plain} % Default style (bold title, italic body)
